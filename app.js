document.addEventListener('DOMContentLoaded', function() {
            ...
            function printTemplate() {
                ...
                container.id = "printPhotosContainer";
                ...
                for (let i = 0; i < 6; i++) {
                    if (currentPhotos[i]) {
                        ...
                        photoDiv.className = 'print-photo';
                ...
                // Mostrar el template de impresión
                document.getElementById('printTemplateDiv').style.display = 'block';
                
                // Imprimir
                window.print();
                
                // Ocultar el template después de imprimir
                setTimeout(() => {
                    document.getElementById('printTemplateDiv').style.display = 'none';
                }, 500);
            }
